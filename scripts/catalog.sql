...
BEGIN
    ...
    VALUES (N'20171018175735_Initial', N'3.1.6');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20180725190153_AddExtraConstraints', N'3.1.6');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190601014740_UpdatingDefaultDataTypes', N'3.1.6');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190818191507_UpdatedConstraints', N'3.1.6');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190911011026_UpdateCatalogModels', N'3.1.6');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20191031185508_Post30Upgrade', N'3.1.6');
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20191105161820_AddressAndCatalogItemOrderedChanges', N'3.1.6');
END;
